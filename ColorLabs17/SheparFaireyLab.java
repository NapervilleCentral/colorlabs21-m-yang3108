...
public class SheparFaireyLab
{
    ...
    public static void main(String[] args)
    {
         ...
         Picture face1 = new Picture("images/cover3.jpg");  //creates the picture for the first method    
         Picture face2 = new Picture("images/cover3.jpg");  //creates the picture for the first method    
         Picture face3 = new Picture("images/cover3.jpg");  //creates the picture for the first method          
